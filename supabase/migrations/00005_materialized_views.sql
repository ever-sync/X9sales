-- Migration 00005: Materialized views for dashboard performance
-- Refreshed every 5 minutes via cron Edge Function

-- ============================================================
-- Dashboard overview: company-level aggregates
-- ============================================================
...
SELECT
    ...
    -- Conversations by status (from conversations table)
...
CREATE UNIQUE INDEX idx_mv_dashboard_overview_company
    ON app.mv_dashboard_overview (company_id);

-- ============================================================
-- Agent ranking: per-agent aggregates for the last 30 days
-- ============================================================
...
-- ============================================================
-- Daily trend: conversations per day for charts
-- ============================================================
...
CREATE UNIQUE INDEX idx_mv_daily_trend_pk
    ON app.mv_daily_trend (company_id, conversation_date, channel);
...
-- ============================================================
-- Refresh function (called by cron Edge Function)
-- ============================================================
