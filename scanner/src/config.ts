...
export const config = {
  ...
  scannerCron: process.env.SCANNER_CRON || '*/2 * * * *',
  aggregatorCron: process.env.SCANNER_AGGREGATOR_CRON || '*/15 * * * *',
  spamDetectorCron: process.env.SCANNER_SPAM_CRON || '*/30 * * * *',
  ...
  batchSize: parseInt(process.env.SCANNER_BATCH_SIZE || '500', 10),
